...
const FaqSectionTwo = ({ faq_area }) => {
  ...
  return (
    <div
      className={` ${faq_area ? faq_area : "faq-area style-3 pt-120 pb-60"}`}
    >
        ...
        <div className="row wow fadeInUp" data-wow-delay=".3s">
          ...
          <div className="col-lg-6">
            <div className="section-title style-2">
              <h2 className="section-main-title mb-55">
                {getTranslation(language, "about.timeline.details.title")}
              </h2>
            </div>
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingSix-st-2">
                        <button
                          ...
                          type="button"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapseSix-st-2"
                          aria-expanded="false"
